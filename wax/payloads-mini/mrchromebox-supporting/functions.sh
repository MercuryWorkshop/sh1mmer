    ...
    if [ ! -f ${cbfstoolcmd} ]; then
        ...
        if [[ "$isChromeOS" = false && "$isChromiumOS" = false ]]; then
            ...
            if [ "${boot_mounted}" = "" ]; then
                ...
                mount "/dev/mmcblk0""${part_num}" /tmp/boot
                if [ $? -ne 0 ]; then
        ...
        cp "${static_source}cbfstool.tar.gz" .
        if [ $? -ne 0 ]; then
            echo_red "Error sourcing cbfstool; cannot proceed."
            #restore working dir
            cd ${working_dir}
            return 1
        fi
...
function get_flashrom() {
    if [ ! -f ${flashromcmd} ]; then
        ...
        if [[ "$isChromeOS" = true ]]; then
            ...
            cp "${static_source}flashrom_old.tar.gz" flashrom.tar.gz
        else
...
function get_gbb_utility() {
    if [ ! -f ${gbbutilitycmd} ]; then
        ...
        cp "${static_source}gbb_utility.tar.gz" .
...
function prelim_setup() {
    ...
    case "${_hwid}" in
    AKALI*)
        _x='KBL|Acer Chromebook 13 / Spin 13'
        device="nami"
        ;;
    ...
    BARD*)
        _x='KBL|Acer Chromebook 715 (CB715)'
        device="nami"
        ;;
    ...
    BLEEMO*)
        _x='KBL|Asus Chromebox 3 / CN65 (Core i7)'
        device="fizz"
        ;;
    ...
    DRALLION*)
        _x='CML|Dell Latitude 7410 Chromebook Enterprise'
        device="drallion"
        ;;
    ...
    EKKO*)
        _x='KBL|Acer Chromebook 714 (CB714)'
        device="nami"
        ;;
    ...
    JAX*)
        _x='KBL|AOpen Chromebox Commercial 2'
        device="fizz"
        ;;
    ...
    KASUMI*)
        _x='STR|Acer Chromebook 311'
        device="kasumi"
        ;;
    KEFKA*) _x='BSW|Dell Chromebook 11 (3180,3189)' ;;
    KENCH*)
        _x='KBL|HP Chromebox G2'
        device="fizz"
        ;;
    ...
    LIBREM_13_V1)
        _x='BDW|Purism Librem 13 v1'
        device="librem13v1"
        ;;
    LIBREM13V1) _x='BDW|Purism Librem 13 v1' ;;
    LIBREM_13_V2)
        _x='SKL|Purism Librem 13 v2'
        device="librem13v2"
        ;;
    LIBREM13V2) _x='SKL|Purism Librem 13 v2' ;;
    LIBREM_13_V3)
        _x='SKL|Purism Librem 13 v3'
        device="librem13v2"
        ;;
    LIBREM13V3) _x='SKL|Purism Librem 13 v3' ;;
    LIBREM_13_V4)
        _x='KBL|Purism Librem 13 v4'
        device="librem13v4"
        ;;
    LIBREM13V4) _x='KBL|Purism Librem 13 v4' ;;
    LIBREM_14)
        _x='CML|Purism Librem 14'
        device="librem_14"
        ;;
    LIBREM_15_V2)
        _x='BDW|Purism Librem 15 v2'
        device="librem15v2"
        ;;
    LIBREM15V2) _x='BDW|Purism Librem 15 v2' ;;
    LIBREM_15_V3)
        _x='SKL|Purism Librem 15 v3'
        device="librem15v3"
        ;;
    LIBREM15V3) _x='SKL|Purism Librem 15 v3' ;;
    LIBREM_15_V4)
        _x='KBL|Purism Librem 15 v4'
        device="librem15v4"
        ;;
    LIBREM15V4) _x='KBL|Purism Librem 15 v4' ;;
    LIBREM_MINI)
        _x='WHL|Purism Librem Mini'
        device="librem_mini"
        ;;
    LIBREM_MINI_V2)
        _x='CML|Purism Librem Mini v2'
        device="librem_mini_v2"
        ;;
    LICK*) _x='GLK|Lenovo Ideapad 3 Chromebook' ;;
    LILLIPUP*)
        _x='TGL|Lenovo IdeaPad Flex 5i Chromebook'
        device="lillipup"
        ;;
    LINDAR-EDFZ*)
        _x='TGL|Lenovo 5i-14 Chromebook'
        device="lindar"
        ;;
    LINDAR-LCDF*)
        _x='TGL|Lenovo Slim 5 Chromebook'
        device="lindar"
        ;;
    ...
    PAINE*)
        _x='BDW|Acer Chromebook 11 (C740)'
        device="auron_paine"
        ;;
    PANTHEON*)
        _x='KBL|Lenovo Yoga Chromebook C630'
        device="nami"
        ;;
    ...
    REEF*)
        _x='APL|Acer Chromebook Spin 11 (R751T)'
        device="electro"
        ;;
    ...
    TERRA*)
        _x='BSW|ASUS Chromebook C202SA, C300SA/C301SA'
        device="terra"
        ;;
    TIDUS*) _x='BDW|Lenovo ThinkCentre Chromebox' ;;
    TREEYA360*)
        _x='STR|Lenovo 300e Chromebook 2nd Gen AMD'
        device="treeya"
        ;;
    TREEYA*)
        _x='STR|Lenovo 100e Chromebook 2nd Gen AMD'
        device="treeya"
        ;;
    TRICKY*) _x='HSW|Dell Chromebox 3010' ;;
    ULTIMA*) _x='BSW|Lenovo ThinkPad 11e/Yoga Chromebook (G3)' ;;
    VAYNE*)
        _x='KBL|Dell Inspiron Chromebook 14 (7486)'
        device="nami"
        ;;
    ...
    WUKONG_???-???-???-??C*)
        _x='KBL|ViewSonic NMP660 Chromebox'
        device="fizz"
        ;;
    WUKONG*)
        _x='KBL|CTL Chromebox CBx1'
        device="fizz"
        ;;
    WYVERN*) _x='CML|CTL Chromebox CBx2' ;;
    YUNA*)
        _x='BDW|Acer Chromebook 15 (CB5-571, C910)'
        device="auron_yuna"
        ;;
